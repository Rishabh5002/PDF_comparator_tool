...
export function MoonIcon({ className = '', width = 13, height = 13 }) {
  return (
...
export function SunIcon({ className = '', width = 13, height = 13 }) {
  return (
    <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function ShieldIcon({ className = '', width = 15, height = 15 }) {
  return (
...
export function UploadIcon({ className = '', width = 18, height = 18 }) {
  return (
    <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function LockIcon({ className = '', width = 12, height = 12 }) {
  return (
    <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
